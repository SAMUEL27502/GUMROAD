...
ALTER TABLE "reviews" ADD COLUMN "verifiedOwner" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "reviews" ADD COLUMN "verifiedOwnerAt" TIMESTAMP(3);

-- CreateIndex
CREATE INDEX "reviews_helpfulCount_idx" ON "reviews"("helpfulCount");
